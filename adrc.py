...
plt.subplot(221)
plt.plot(T, eso1[:, 0], label="q_o_hat")
plt.plot(T, Q[:, 0], 'r', label ="q_0")
plt.legend()
plt.subplot(222)
plt.plot(T, eso1[:, 1], label = 'q_1_hat')
plt.plot(T, Q[:, 2], 'r', label = 'q_1')
plt.legend()
plt.subplot(223)
plt.plot(T, eso2[:, 0],label ='q_dot_1_hat')
plt.plot(T, Q[:, 1], 'r', label = "q_dot_1")
plt.legend()
plt.subplot(224)
plt.plot(T, eso2[:, 1], label = 'q_dot_2_hat')
plt.plot(T, Q[:, 3], 'r', label = "q_dot_2")
plt.legend()
plt.show()
...
plt.subplot(221)
plt.plot(T, Q[:, 0], 'r', label = "q_0")
plt.plot(T, Q_d[:, 0], 'b', label = "q_0_d")
plt.legend()
plt.subplot(222)
plt.plot(T, Q[:, 1], 'r', label = "q_1")
plt.plot(T, Q_d[:, 1], 'b', label = "q_1_d")
plt.legend()
plt.subplot(223)
